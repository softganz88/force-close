...
short: open an issue to discuss anything non-trivial, keep changes surgical, and
make sure `bash -n`, `shellcheck -S warning`, and `bats tests/` all pass. Read
the safety rules before touching the kill path.
